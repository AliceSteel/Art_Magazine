<template>
	<footer>
		<div class="black_running_line"><i>NEWSLETTER+++ NEWSLETTER+++ NEWSLETTER+++</i>
		</div>
		<div class="container footer_wrap">
			<div class="design_news_sign_up">
				...
				<form class="sign_up_form">
					...
					<button type="submit" class="white_btn"><i>sign up</i></button>
				</form>
			</div>
			<ul class="links">

				<li>
					<router-link to="#" target="_blank" rel="nofollow, noreferrer" class="logo_wrap">
						<img src='@/assets/images/logo_white.png' alt="logo" />
					</router-link>
				</li>
				<li>
					<router-link to="#" target="_blank" rel="nofollow, noreferrer">
						Magazine
					</router-link>
				</li>
				<li>
				...
				<ul class="links">
					...
					<li>
						<router-link to="#">
							<svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path
									d="M3 3C12.941 3 21 11.059 21 21H18C18 12.716 11.284 6 3 6V3ZM3 10C9.075 10 14 14.925 14 21H11C11 18.8783 10.1571 16.8434 8.65685 15.3431C7.15656 13.8429 5.12173 13 3 13V10ZM3 17C4.06087 17 5.07828 17.4214 5.82843 18.1716C6.57857 18.9217 7 19.9391 7 21H3V17Z"
									fill="white" />
							</svg>
						</router-link>
					</li>
